<template>
  <div>
    ...
    <FormItem label="服务编码"  prop="keyboard">
            <Input type="text"  v-model="formValidate.serviceid" name = "keyboard" style="width: 200px"></Input>
    </FormItem>
     </FormItem>
...
import { addSubmit } from '@/api/fuyaoAssetPdBat'
export default {
  name: 'params',
  data () {
      return {
